...
<template>
  <header class="sticky top-0 left-0 z-50 flex flex-row w-full bg-primary p-2 justify-between items-center lg:px-4">
    <div class="flex flex-col text-white">
      ...
      <span class="text-xs font-light lg:text-sm">School of Information Technology, KMUTT</span>
    </div>
    <button class="text-white text-xs font-bold bg-gradient-to-b from-button px-4 py-1.5 h-fit to-button/50 shadow-md rounded-lg lg:text-sm">
      Log In
    </button>
  </header>
